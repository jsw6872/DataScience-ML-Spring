...
if __name__ == '__main__':
    train_path = '/home/seongwoo/workspace/DataScience_ML-DL/DL/assignment/trash_detection/data/train.json'
    ...
    model.roi_heads.box_predictor = torchvision.models.detection.FastRCNNPredictor(in_features, 11)
    evaluate(model, data_loader_test_coco)
    # iou_types = _get_iou_types(model)
    # coco_evaluator = CocoEvaluator(coco, iou_types)