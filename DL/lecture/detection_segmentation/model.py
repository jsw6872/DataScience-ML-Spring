...
class Yolov4(nn.Module):
    ...
    def forward(self, input):
        ...
        x20, x13, x6 = self.neck(d5, d4, d3)# 여기까진 shape 같음
...
if __name__ == "__main__":
    ...
    img = cv2.imread('/home/seongwoo/workspace/pytorch-YOLOv4/data/train/2010_005190_jpg.rf.fa6e927cc548dd04f715348d085064f2.jpg')
    ...
    plot_boxes_cv2(img, boxes[0], 'test.jpg', class_names)
